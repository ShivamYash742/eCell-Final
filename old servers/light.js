...
<head>
    ...
    <style>
        :root {
            --bg-primary: #f4f4f4; /* Light gray background */
            --bg-secondary: #ffffff; /* White background for cards */
            --accent-primary: #000080; /* Navy blue */
            --accent-secondary: #6fa3ef; /* Lighter navy accent */
            --text-primary: #333333; /* Dark gray text */
            --text-secondary: #666666; /* Light gray text */
            --card-bg: #ffffff; /* White background for cards */
            --glow-color: rgba(0, 0, 128, 0.2); /* Soft navy glow */
        }
